...
namespace Unidash.Core.Tests.Infrastructure
{
    /// <summary>
    ...
    public class RepositoryTestData<T> : IEnumerable<object[]>
    {
        public IEnumerator<object[]> GetEnumerator()
        {
            ...
            yield return new object[] { new MongoEntityRepository<GenericEntity<T>>("mongodb://localhost:27018", Guid.NewGuid().ToString()) };
        }
    ...
    public class RepositoryTests : IClassFixture<Mongo2GoDatabaseFixture>
    {
        ...
        {
            // Arrange
            const string expectedKey = "kitchen@unidash.pro";
